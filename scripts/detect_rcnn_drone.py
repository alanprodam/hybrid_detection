...
class Detector:
    ...
    def __init__(self):
        ...
        self.pub_debug = rospy.Publisher('debug/distance', Vector3, queue_size=1)
        
        rospy.Subscriber('bebop/odom',Odometry, self.callbackOdom, queue_size = 1)
    ...
    def callbackPoseAruco(self, pose):
    ...
    def image_callback(self, data):
        ...
        true_positive_rcnn = 0
        true_positive_aruco = 0
        rcnn_value_z = 0

        if (self.pose_aruco != self.pose_aruco_ant):
            true_positive_aruco = 1
        else:
            true_positive_aruco = 0

        self.pose_aruco_ant = self.pose_aruco
